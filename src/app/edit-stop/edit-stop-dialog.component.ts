...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, MatButtonModule, MatInputModule, MatFormFieldModule, MatDialogModule],
  template: `
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-raised-button color="primary" [disabled]="!stopForm.valid" (click)="onSubmit()">Save Changes</button>
    </mat-dialog-actions>
  `,
  styles: [
    `
